...
arv.InserirNode(20,'Oxente')
arv.InserirNode(11,'Oxente')
arv.InserirNode(22,'Oxente')
arv.InserirNode(13,'Oxente')
arv.InserirNode(15,'Oxente')
arv.InserirNode(19,'Oxente')
arv.InserirNode(40,'Oxente')
arv.InserirNode(23,'Oxente')
arv.InserirNode(10,'Oxente')
arv.InserirNode(5,'Oxente')
arv.InserirNode(21,'Oxente')
arv.InserirNode(12,'Oxente')
arv.InserirNode(18,'Oxente')
arv.emordem()
